...
def get_epoch_from_uniqval(test_dir, val_dir):
    print("test_dir:", test_dir,",val_dir:",val_dir)
    ...
    print("test_epch_ndcg_err:",test_epoch_ndcg_err)
    print("val_epoch_ndcg_err : ",val_epoch_ndcg_err)
    ...
    def read_all_pred(pred_dir): 
        ...
        for run in os.listdir(pred_dir):
            ...
            if len(cols) == 5:
                ...
                run_epoch_ndcg_err[nb_epoch] = (run, ndcg, err)
                print("run_eoch_ndcg_err : ", run_epoch_ndcg_err)
        return run_epoch_ndcg_err
