...
def load_train_data_generator(qids, rawdoc_mat_dir, qid_cwid_label, N_GRAMS, param_val,\
    ...
    print("==> load_train_data_generator qids:",qids, ", qid_cwid_label len:",len(qid_cwid_label),",N_GRAMS : ",N_GRAMS)
    ...
    for cwid in qid_cwid_rmat:
        ...
        for cwid2 in qid_cwid_rmat[cwid]:
            print("qid_cwid_rmat2 len :",len(qid_cwid_rmat[cwid][cwid2])," cwid2 : ",cwid2,",len :", len(qid_cwid_rmat[cwid][cwid2][1]))
