...
qid_year=dict(zip(list(range(1,301)), ['wt09'] * 50 + ['wt10'] * 50 + \
                ['wt11'] * 50 + ['wt12'] * 50 + ['wt13'] * 50 + ['wt14'] * 50+['wt15']*1))

year_qids={'wt09':list(range(1,51)),'wt10':list(range(51,101)),\
               'wt11':list(range(101,151)),'wt12':list(range(151,201)),\
               'wt13':list(range(201,251)), 'wt14':list(range(251,301)), 'wt15':list(range(301,302))}

def get_train_qids(year, years=['wt09', 'wt10', 'wt11', 'wt12', 'wt13', 'wt14','wt15']):
