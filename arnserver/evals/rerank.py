...
def main(_log, _config):
    ...
    print("list_of_model_params : ",list_of_model_params)
    expids = list()
    ...
    for train_years in train_test_years:
        ...
        for i in range(len(train_test_years[train_years])):
            ...
            print("test_year : ", test_year, ",val_year:",val_year)
            ...
            for expid in expids:
                ...
                if not os.path.isdir(pred_dir) or not os.path.isdir(val_dir):
                    ...
                    continue
                '''
                print("===============>pred_dir: ",pred_dir,",=========>expid:",expid)
            ...
            test_qids = [str(qid) for qid in range(1,50)]
            print("test_qids:",test_qids)
